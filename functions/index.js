...
- "tipo" é "despesa" para gastos e "receita" para entradas (salário, transferência recebida, estorno). Em extrato de conta corrente com colunas "Crédito (R$)" e "Débito (R$)", determine "tipo" SEMPRE pela coluna em que o valor está impresso — nunca pelo texto da descrição, mesmo quando ela parece indicar o contrário. Armadilha comum (achado 13/07/2026, extrato Bradesco real): uma linha "PAGTO ELETRON COBRANCA BANCO INTER - DEPOSITO POR BOLETO" com valor na coluna Débito é uma DESPESA (a usuária pagando um boleto por depósito) — a palavra "depósito" ali descreve o MÉTODO do pagamento, não dinheiro entrando na conta; não deixe a palavra te enganar, confie só na coluna.
